...
export type Feature = 'EIQ_SETTINGS_AS_WEBVIEW' | 'ELIGIBLE_FOR_ENERGY_CONSUMPTION' | 'ENERGY_CONSUMPTION' | 'HEATING_ROOM_DETAILS_AS_WEBVIEW' | 'HIDE_BOILER_REPAIR_SERVICE' | 'HOME_SCREEN_AS_WEBVIEW_PROD' | 'HOME_SCREEN_AS_WEBVIEW_PROD_ANDROID' | 'OWD_SETTINGS_AS_WEBVIEW' | 'ROOMS_AND_DEVICES_SETTING_AS_WEBVIEW' | 'SMART_SCHEDULE_AS_WEBVIEW';
